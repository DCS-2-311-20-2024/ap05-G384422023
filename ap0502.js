...
function init() {
  ...
  // 2段目
  setUvs( 6, 1, 2); setUvs( 7, 9, 2);
  setUvs( 8, 7, 2); setUvs( 9, 5, 2); setUvs( 5, 3, 2);
  // 3段目
  setUvs( 15, 2, 3); setUvs( 16, 0, 3); setUvs(17, 8, 3)
  setUvs(18, 6, 3); setUvs(19, 4, 3);
  // 最下段
  setUvs( 10, 2, 4); setUvs( 11, 0, 4); setUvs(12, 8, 4);
  setUvs(13, 6, 4);  setUvs(14, 4, 4);
